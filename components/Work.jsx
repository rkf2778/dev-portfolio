  ...
  return (
    <>
      ...
      <motion.div
        ...
        layout
        className="card group relative mb-10 overflow-hidden rounded-xl border border-gray-200 bg-white p-8 shadow dark:border-gray-800 dark:bg-gray-900"
      >
        {/* BG ANIMATION */}
        ...
        <div className="mb-6 flex flex-col gap-9">
          ...
          <div className="flex w-full flex-wrap place-items-center gap-6 border-gray-200 dark:border-gray-800">
            {/* DEMO button */}
            {post.liveURL && (
              <a
                href={post.liveURL}
                className="group flex h-8 items-center justify-center gap-1.5 rounded-xl bg-gray-100 p-[25px] px-3.5 text-xl text-gray-950 *:select-none hover:bg-gray-200/75 active:bg-gray-100 disabled:border disabled:border-gray-200 disabled:bg-gray-100 disabled:text-gray-950 *:disabled:opacity-20 dark:bg-gray-500/10 dark:text-white dark:hover:bg-gray-500/15 dark:active:bg-gray-500/10 dark:disabled:border-gray-800/50 disabled:dark:bg-gray-900 dark:*:disabled:!text-white [&>*:not(.sr-only)]:relative"
              >
                <span>View Demo</span>
                <svg
                  viewBox="0 0 24 24"
            ...
            {post.githubUrl && (
              <a
                href={post.githubUrl}
                className="p-25px group flex size-9 h-[50px] w-10 items-center justify-center rounded-xl bg-gray-100 p-5 text-gray-950 *:select-none hover:bg-gray-200/75 active:bg-gray-100 disabled:border disabled:border-gray-200 disabled:bg-gray-100 disabled:text-gray-950 *:disabled:opacity-20 dark:bg-gray-500/10 dark:text-white dark:hover:bg-gray-500/15 dark:active:bg-gray-500/10 dark:disabled:border-gray-800/50 disabled:dark:bg-gray-900 dark:*:disabled:!text-white [&>*:not(.sr-only)]:relative"
              >
            ...
            {post?.kaggleUrl && (
              <a
                href={post?.kaggleUrl}
                className="w-15 group flex size-9 w-[90px] p-1 items-center justify-center rounded-xl bg-gray-100 text-gray-950 *:select-none hover:bg-gray-200/75 active:bg-gray-100 disabled:border disabled:border-gray-200 disabled:bg-gray-100 disabled:text-gray-950 *:disabled:opacity-20 dark:bg-gray-500/10 dark:text-white dark:hover:bg-gray-500/15 dark:active:bg-gray-500/10 dark:disabled:border-gray-800/50 disabled:dark:bg-gray-900 dark:*:disabled:!text-white [&>*:not(.sr-only)]:relative h-[50px]"
              >
                <span className="sr-only">Kaggle</span>
