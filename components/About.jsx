...
function About() {
  return (
    <div className="flex min-h-screen items-center bg-[#161513] pb-20 pt-3 md:pt-16">
      {/* ABOUT CONTAINER */}
      <div className="mx-auto flex flex-col place-items-center py-[20px] sm:pt-[160px]">
        ...
        <section className="flex flex-col place-items-center">
          <p className="mb-11 text-3xl font-bold text-white">
            Hi, I&apos;m{" "}
        ...
        <section className="flex-center flex-col gap-2 md:flex-row md:gap-5">
          ...
          <a
            href="https://drive.google.com/drive/folders/1Zoqk2gs-uQj-ZoRgb_pQ2n4o5Cz4qY2p?usp=sharing"
            target="_blank"
            download
